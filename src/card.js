...
export class UninusGreenhouseRollupCard extends HTMLElement {
  ...
  static styles = `
    ...
    .face-head{display:grid;grid-template-columns:var(--ui-icon-size) minmax(0,1fr) auto;align-items:center;gap:7px;margin-bottom:9px}.compass{display:grid;place-items:center;width:var(--ui-icon-size);height:var(--ui-icon-size);border-radius:9px;background:color-mix(in srgb,var(--face-accent) 13%,transparent);border:1px solid color-mix(in srgb,var(--face-accent) 25%,transparent);color:var(--face-accent);font-size:var(--ui-icon-font-size);font-weight:900}.name{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:var(--ui-name-size);font-weight:800}.motion{display:inline-flex;align-items:center;gap:5px;padding:5px 7px;border-radius:999px;background:color-mix(in srgb,var(--status-color) 13%,transparent);border:1px solid color-mix(in srgb,var(--status-color) 32%,transparent);color:var(--status-color);font-size:var(--ui-motion-size);font-weight:800;white-space:nowrap}.motion i{width:7px;height:7px;border-radius:50%;background:var(--status-color)}.moving .motion i{box-shadow:0 0 9px var(--status-color);animation:pulse 1s ease-in-out infinite}
    ...
    .foot{display:flex;align-items:end;justify-content:space-between;gap:7px;margin-top:8px;text-align:left}.more-info{all:unset;box-sizing:border-box;display:flex;align-items:end;justify-content:space-between;gap:7px;width:100%;border-radius:6px;cursor:pointer}.more-info:focus-visible{outline:2px solid var(--face-accent);outline-offset:2px}.copy{display:grid;min-width:0;gap:2px}.copy strong,.copy small{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.copy strong{font-size:var(--ui-detail-size)}.copy small{color:var(--rollup-muted);font-size:var(--ui-meta-size)}.foot em{color:var(--face-accent);font-size:var(--ui-position-size);font-style:normal;font-weight:900}
    .controls{display:grid;grid-template-columns:repeat(var(--control-count,3),minmax(0,1fr));gap:5px;margin-top:8px}.controls button{min-width:0;min-height:var(--ui-control-height);padding:6px 4px;border:1px solid color-mix(in srgb,var(--face-accent) 30%,transparent);border-radius:8px;background:color-mix(in srgb,var(--face-accent) 11%,transparent);color:var(--rollup-text);font:inherit;font-size:var(--ui-control-size);font-weight:800;cursor:pointer}.controls button:hover{background:color-mix(in srgb,var(--face-accent) 22%,transparent)}.controls button:focus-visible{outline:2px solid var(--face-accent);outline-offset:1px}.controls button:disabled{cursor:not-allowed;opacity:.38}.controls .stop{border-color:color-mix(in srgb,var(--rollup-moving) 35%,transparent)}
    .global-controls{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:7px;margin:-2px 2px 14px;padding:7px;border:1px solid color-mix(in srgb,var(--rollup-text) 9%,transparent);border-radius:13px;background:color-mix(in srgb,var(--rollup-surface) 68%,transparent)}.global-controls button{--global-accent:var(--open-color);min-width:0;height:var(--ui-global-height);border:1px solid color-mix(in srgb,var(--global-accent) 38%,transparent);border-radius:9px;background:color-mix(in srgb,var(--global-accent) 13%,transparent);color:var(--rollup-text);font:inherit;font-size:var(--ui-global-size);font-weight:900;letter-spacing:.04em;cursor:pointer}.global-controls button::before{display:inline-block;margin-right:6px;color:var(--global-accent)}.global-controls .global-open::before{content:'▲'}.global-controls .global-stop::before{content:'■'}.global-controls .global-close::before{content:'▼'}.global-controls button:hover{background:color-mix(in srgb,var(--global-accent) 24%,transparent)}.global-controls button:focus-visible{outline:2px solid var(--global-accent);outline-offset:1px}.global-controls button:disabled{cursor:not-allowed;opacity:.38}
